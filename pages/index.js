...
const linkClass =
  'flex flex-col w-full overflow-hidden transition shadow-sm rounded cursor-pointer group focus-visible:outline-none focus-visible:ring focus-visible:ring-blue-700 bg-white';

export default function Home() {
  return (
    <>
      <section className="max-w-2xl px-4 py-12 mx-auto md:px-0 sm:text-center">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-800 sm:text-4xl sm:leading-tight">
          React UI Elements for Tailwind CSS
        </h1>
        <p className="mt-2 text-gray-500 md:text-lg">
          Nila is a UI component library which has several elements that are
